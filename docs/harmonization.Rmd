...
```{r}
p<-plot_harmonization(res_anisole, title = "Calibration Harmonization - Anisole")
ggsave(
  filename = file.path("figures", "harmonization_anisole.pdf"),
  plot = p,
  width = 6,
  height = 4,
  device = cairo_pdf
...
```{r, echo=TRUE}
p <- plot_harmonization(
  res_heptanone,
  title = "Calibration Harmonization - Heptanone"
)

ggsave(
  filename = file.path("figures", "harmonization_heptanone.pdf"),
  plot = p,
  width = 6,
  height = 4,
  device = cairo_pdf
...
```{r, echo=FALSE}
ggsave(
  filename = file.path("figures", "loss_heatmap_anisole_real.pdf"),
  plot = hm_anisole$real,
  width = 6,
  height = 5,
  device = cairo_pdf
)
ggsave(
  filename = file.path("figures", "loss_heatmap_anisole_paraboloid.pdf"),
  plot = hm_anisole$paraboloid,
  width = 6,
  height = 5,
  device = cairo_pdf
)
...
```{r, echo=FALSE}
ggsave(
  filename = file.path("figures", "loss_heatmap_heptanone_real.pdf"),
  plot = hm_heptanone$real,
  width = 6,
  height = 5,
  device = cairo_pdf
)
ggsave(
  filename = file.path("figures", "loss_heatmap_heptanone_paraboloid.pdf"),
  plot = hm_heptanone$paraboloid,
  width = 6,
  height = 5,
  device = cairo_pdf
)
...
p <- plot_loss_1d(
  res_anisole,
  param = "scale",
  title = "Anisole - Loss vs scale"
)

ggsave(
  filename = file.path("figures", "loss_1d_anisole_scale.pdf"),
  plot = p,
  width = 6,
  height = 4,
  device = cairo_pdf
...
p <- plot_loss_1d(
  res_anisole,
  param = "shift",
  title = "Anisole – Loss vs shift"
)

ggsave(
  filename = file.path("figures", "loss_1d_anisole_shift.pdf"),
  plot = p,
  width = 6,
  height = 4,
  device = cairo_pdf
...
p <- plot_loss_1d(
  res_heptanone,
  param = "scale",
  title = "Heptanone – Loss vs scale"
)

ggsave(
  filename = file.path("figures", "loss_1d_heptanone_scale.pdf"),
  plot = p,
  width = 6,
  height = 4,
  device = cairo_pdf
...
p <- plot_loss_1d(
  res_heptanone,
  param = "shift",
  title = "Heptanone – Loss vs shift"
)

ggsave(
  filename = file.path("figures", "loss_1d_heptanone_shift.pdf"),
  plot = p,
  width = 6,
  height = 4,
  device = cairo_pdf
